    ...
    <section className="bg-white dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 py-16 grid grid-cols-1 lg:grid-cols-2 items-center gap-40">
        ...
        <div className="flex justify-center relative">
          ...
          <div className="bg-[#E9DFC9] dark:bg-gray-800 rounded-t-full w-[300px] xl:h-[600px] h-[500px] relative shadow-lg overflow-visible">
            {/* الصورة فوق الخلفية */}
          </div>
          <img
            src={home2}
        ...
        <div className="space-y-8 w-max-1 xl:text-left text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-serif font-extrabold text-[#33404D] dark:text-gray-100 leading-tight">

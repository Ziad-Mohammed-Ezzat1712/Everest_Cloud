...
export default function ContactUs() {
  return (
   ...
   <div className="flex justify-center mb-6"><img src={imogy} alt="smail" className="w-10 h-10 object-contain text-center  rounded-full " /></div>
      <div className='text-center'> <h4 className="uppercase text-[#D1B88F]  text-[20px] font-semibold ">Get in touch</h4>
 ...
 <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-white shadow-sm rounded-xl p-12">
          ...
          <form className="flex flex-col gap-4">
            <div>
              ...
              <input
                type="text"
                className="w-full border rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-[#D1B88F]"
              />
            </div>
            <div>
            ...
            <button
              type="submit"
              className="w-max-1 bg-gradient-to-r from-[#D1B88F] to-[#E9DFC9]  hover:from-[#33404D] hover:to-[#435260] cursor-pointer hover:text-white py-3  rounded-lg font-bold text-[18px] shadow-lg hover:bg-orange-600 transition"
            >
              Submit
            </button>
          </form>
     ...
     <div className="flex justify-center mb-6"><img src={time} alt="smail" className="w-10 h-10 object-contain text-center  rounded-full " /></div>
      <div className='text-center'> <h4 className="uppercase text-[#D1B88F]  text-[20px] font-semibold ">How to get to us</h4>
        <h2 className="text-5xl   font-bold mt-2 mb-6 ">
          Find our store
        </h2>

        <div class="mb-10 p-8">
  <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3453.6169657915743!2d31.35075552382529!3d30.047844918408483!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x14583e7c2b423207%3A0x1a6c3486f518f331!2z2YXYudmH2K8g2KfZhNij2YTYs9mGINin2YTYudin2YTZiiDZhNmE2LPZitin2K3YqSDZiNin2YTZgdmG2KfYr9mCINmI2KfZhNit2KfYs9ioINin2YTYo9mE2Yk!5e0!3m2!1sar!2seg!4v1756120510992!5m2!1sar!2seg" width="1100" height="600"  className='mx-auto'></iframe>
</div>
     </div>

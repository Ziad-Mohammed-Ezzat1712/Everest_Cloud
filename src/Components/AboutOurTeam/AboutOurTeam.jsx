...
export default function AboutOurTeam() {
  ...
  return (
<>
    <div className="bg-gradient-to-r from-[#33404D] to-[#29323b] py-22  text-center ">
      
   
       <h4 className="uppercase text-[#D1B88F] text-[20px] font-semibold ">our team</h4>
        <h2 className="text-6xl text-white  font-bold mt-2 mb-10 ">
          Meet our vaping experts
        </h2>
      <p className="text-gray-300 max-w-lg text-lg mx-auto font-medium mb-22 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12 max-w-6xl mx-auto space-y-8">
        {ourteam.map((ourteams) => (
          ...
          >
            ...
            />
           <div className="mt-10 "> <h3 className="font-bold text-white text-[25px]">{ourteams.name}</h3>
            <p className="text-md text-white font-medium mt-3 ">{ourteams.job}</p></div>
     ...
     <div className="mt-10">
        <Link
          to="#"
          className="text-[#D1B88F] text-[25px] font-semibold flex items-center justify-center gap-2 hover:text-white transition"
        >
          View all Team →
        </Link>
      </div>
